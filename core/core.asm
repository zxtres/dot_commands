...
BootZX3             proc
                    ...
                    or l
                    cp 1
                    jr nz,NotCore1   ;el core 1 tiene una dirección especial
                    ld hl,0010h
                    ld bc,1
                    jr CalcAddressAndBoot
NotCore1            dec hl
                    ld b,h
                    ld c,l      ; BC = core elegido (2 en adelante)
                    ld hl,0027h ; bits 31 a 16 de la dirección. Los bits 15 a 0 valen 0
                    ld de,0012h ; tamaño de cada core (bits 31 a 16 del tamaño). Al principio vale 0017 y luego vale 0012
                    jr CalcAddressAndBoot
                    endp
;------------------------------------------------------
